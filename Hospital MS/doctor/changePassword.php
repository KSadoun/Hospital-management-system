  ...
  <div class="page">
    ...
    <form class="login-form" action="changePassword.inc.php" method="POST">  
      <div class="information">
        ...
        <div class="input-box">
          <i class="fa fa-lg fa-lock"></i>
          <input type="password" placeholder="Repeat New Password" name="repeat-password"></input>
        </div>
...
?> 
        ...
        <p class="text-muted" style="display: inline-block;">Done? </p><a href="dashboard.php"> Return to dashboard</a>
