...
<?php
  if (isset($_GET['phone'])) {
    ...
    echo '<div class="input-box">
        ...
        <input type="number" placeholder="Phone Number Registered" name="phone" value="'.$phone.'"></input>
      </div><br>';
  }
  else{
    echo '<div class="input-box">
        <i class="fa fa-lg fa-phone"></i>
        <input type="number" placeholder="Phone Number Registered" name="phone"></input>
      </div><br>';
  }
...
<?php
  if (isset($_GET['err'])) {
    ...
    elseif ($errorCheck == 'invalid') {
      echo "<p class='text-danger'>Phone Number or Email Address is invalid</p>";
    }
